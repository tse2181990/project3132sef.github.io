...
<html>
<head>
  <title><spring:message code="lecture.add"/></title>
...
<div class="container mt-4">
  ...
  <div class="card">
    <div class="card-header bg-primary text-white">
      <h4 class="mb-0"><spring:message code="lecture.add"/></h4>
    </div>
    <div class="card-body">
      <form method="post" action="<c:url value='/lecture/create'/>" enctype="multipart/form-data">
        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
        ...
        <div class="mb-3">
          <label class="form-label"><spring:message code="lecture.materials"/></label>
          <input type="file" name="attachments" class="form-control" multiple/>
          <div class="form-text"><spring:message code="lecture.attachmentsHint"/></div>
        </div>
