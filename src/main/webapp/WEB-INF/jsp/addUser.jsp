...
<div class="container mt-4">
  ...
  <div class="card">
    <div class="card-header bg-primary text-white">
      <h4 class="mb-0"><spring:message code="user.add"/></h4>
    </div>
    <div class="card-body">
      <form method="post" action="<c:url value='/user/create'/>">
        ...
        <div class="mb-3">
          ...
          <select name="roles" class="form-select">
            <option value="ROLE_STUDENT"><spring:message code="role.student"/></option>
            <option value="ROLE_TEACHER"><spring:message code="role.teacher"/></option>
          </select>
        </div>
